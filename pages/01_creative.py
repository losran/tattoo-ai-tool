...
with col_main:
    ...
    if execute_button:
        ...
        with st.spinner("🚀 灵感爆发中..."):
            ...
            prompt = f"风格：{tone}。意图：{intent_input if has_intent else '自由'}。从库中拼贴15-18个词形成艺术长句，每行一个，中文逗号分隔。禁止JSON。【核心要求】： 1. 不要死板！请从词库中自由组合 10-18 个词汇。 2. 结构：风格 + 风格 +风格 +主体 + 随机动作 + 随机氛围 + 随机氛围 + 随机氛围 + 随机氛围 + 随机氛围 + 身体部位。 3. 要有一种“破碎、拼贴”的艺术感，词汇之间要有反差。 4. 输出格式：纯中文，用逗号分隔。参考库：{smart_db}"
